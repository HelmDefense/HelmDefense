...
public class GalvanizeAbility extends Ability {
	...
	public GalvanizeAbility(Tier unlock, Tier.Specification tierSpecification) {
		this(unlock, tierSpecification, 15, 6d, 0.05d);
	}

	public GalvanizeAbility(Tier unlock, Tier.Specification tierSpecification, Integer duration, Double effectRange, Double value) {
